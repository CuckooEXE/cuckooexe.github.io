...
![ImperfectProjector]({{ site.baseurl }}/images/ImperfectProjector/ImperfectProjector.png)
...
![Main Board]({{ site.baseurl }}/images/ImperfectProjector/board-annotated.png)
...
![Solder Work]({{ site.baseurl }}/images/ImperfectProjector/solder.jpg)
...
![XMC Chip]({{ site.baseurl }}/images/ImperfectProjector/flash-chip.png)
...
![XM25QH128C Schematic]({{ site.baseurl }}/images/ImperfectProjector/schematic.png)
...
![Ordering Information]({{ site.baseurl }}/images/ImperfectProjector/ordering-information.png)

We can reference Figure 2a on the Data Sheet to figure out the pin orientation, too:

![Wiring Diagram]({{ site.baseurl }}/images/ImperfectProjector/better-diagram.png)
...
![SPI Mem Manager Wiring Guide]({{ site.baseurl }}/images/ImperfectProjector/flipper-wiring-guide.png)
...
![Detecting Screen]({{ site.baseurl }}/images/ImperfectProjector/detecting.png)
![FlipperZero Wiring]({{ site.baseurl }}/images/ImperfectProjector/flipper-wiring.png)
...
![ARP Poison]({{ site.baseurl }}/images/ImperfectProjector/ettercap-connection.png)
...
![Reading the Flash ROM]({{ site.baseurl }}/images/ImperfectProjector/rom-read.png)
...
![OTA Configuration Key Usage]({{ site.baseurl }}/images/ImperfectProjector/ota-config-key.png)
...
![Function References]({{ site.baseurl }}/images/ImperfectProjector/func-references.png)
